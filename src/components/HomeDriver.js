  ...
  return (
    ...
    <View style={styles.box}>
      ...
      <View style={styles.box1}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('TrackDriver')}><Image style={styles.img} source={require('../images/g_truck.png')} /></TouchableOpacity>
        
      </View>

      <View style={styles.box2}>
        <Text style={styles.txt}>Check collection</Text>
        <TouchableOpacity onPress={() => navigation.navigate('HomeDriver')}><Image style={styles.img} source={require('../images/schedule.png')} /></TouchableOpacity>
      </View>
      ...
      <View style={styles.box2}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('HomeDriver')}><Image style={styles.img} source={require('../images/community.png')} /></TouchableOpacity>
      </View>
      </View>
